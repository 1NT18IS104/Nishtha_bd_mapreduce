...
public void map(LongWritable key, Text value, OutputCollector<Text, IntWritable> output, Reporter reporter) throws IOException {
	...
	if(Integer.parseInt(empDetails[2])==30000) {
		output.collect(new Text("Total number of awards won by employees with a salary of 30000: "), awards);
	}
	}
}
...
public static void main(String[] args) throws Exception {
	JobConf conf = new JobConf(ProgressCheck.class);
	conf.setJobName("Total Awards with Salary Check");
